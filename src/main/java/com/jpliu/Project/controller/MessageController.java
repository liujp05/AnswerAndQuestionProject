...
import com.jpliu.Project.model.ViewObject;
...
public class MessageController {
    ...
    public String getConversationDetail(Model model, @RequestParam("conversationId") String conversationId) {
        ...
        try {
            ...
            //更新未读
            messageService.updateConversationUnread(localUserId, conversationId, 1);
    ...
    public String addMessage(@RequestParam("toName") String toName,
        ...
        try {
            if (hostHolder.getUser() == null) {
                return MD5Util.getJSONString(999, "未登录");
            }

            User user = userService.selectByName(toName);
            if (user == null) {
                return MD5Util.getJSONString(1, "用户不存在");
            }
            ...
            return MD5Util.getJSONString(1, "发信失败");
        }
